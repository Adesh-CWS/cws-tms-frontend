...
const EmployeeTasklog = ({ user }) => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const logRes = await fetch(
        `https://cws-tms-backend.vercel.app/api/tasklogs/employee/${user._id}`,
        {
          headers: {
  ...
  const handleDelete = async (logId, e) => {
    ...
    try {
      const response = await fetch(`https://cws-tms-backend.vercel.app/api/tasklogs/${logId}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`,
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      const endpoint = editIndex !== null
        ? `https://cws-tms-backend.vercel.app/api/tasklogs/${editIndex}`
        : "https://cws-tms-backend.vercel.app/api/tasklogs/";
