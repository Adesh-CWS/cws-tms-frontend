...
function MangerDashbarodTMS() {
  ...
  const fetchUser = async () => {
    try {
      ...
      const res = await axios.get("https://cws-tms-backend.vercel.app/me", {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const taskRes = await axios.get(
          `https://cws-tms-backend.vercel.app/manager/emp/task/${user._id}/`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
    ...
    const fetchAvailableEmployees = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://cws-tms-backend.vercel.app/manager/${managerId}/available-employees`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
