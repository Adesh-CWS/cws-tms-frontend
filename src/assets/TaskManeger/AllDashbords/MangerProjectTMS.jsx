...
const API_URL = "https://cws-tms-backend.vercel.app/api/projects";
...
function ManagerProjectTMS({ user }) {
  ...
  //       apiUrl = `https://cws-tms-backend.vercel.app/api/projects/${projectId}/complete`;
  //     } else if (newStatus === "Cancelled") {
  //       apiUrl = `https://cws-tms-backend.vercel.app/api/projects/${projectId}/cancel`;
  //     }
  ...
  const fetchProjectComments = async (projectId) => {
    ...
    try {
      const response = await axios.get(
        `https://cws-tms-backend.vercel.app/project/${projectId}/comments`,
      );
  ...
  const handleSubmitComment = async () => {
    ...
    try {
      const res = await axios.post(
        `https://cws-tms-backend.vercel.app/project/${commentModalProject._id}/comment`,
        { comment: newComment },
        {
          headers: {
  ...
  const handleDeleteComment = async (commentId, projectId) => {
    ...
    try {
      const res = await axios.delete(
        `https://cws-tms-backend.vercel.app/project/${projectId}/comment/${commentId}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
          },
