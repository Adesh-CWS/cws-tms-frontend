...
const EmployeeTaskTMS = ({ user }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://cws-tms-backend.vercel.app/tasks/assigned/${user._id}`)
      .then((res) => {
...
if (activeTask) {
  ...
  useEffect(() => {
    fetch("https://cws-tms-backend.vercel.app/unique")
      .then((res) => res.json())
      .then((data) => {
        if (data.success) {
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `https://cws-tms-backend.vercel.app/task/${selectedTask._id}/status`,
        {
          method: "PUT",
  ...
  const handleStartTimer = async (taskId) => {
    ...
    try {
      const response = await axios.post(
        `https://cws-tms-backend.vercel.app/task/${taskId}/start`,
      );
...
setTimerSeconds(previousSeconds); 
  ...
  try {
    const response = await axios.post(
      `https://cws-tms-backend.vercel.app/task/${taskId}/stop`
    );
...
//snehal code
  ...
  const handleStartTask = async (task) => {
    ...
    try {
      const statusRes = await fetch(
        `https://cws-tms-backend.vercel.app/task/${task._id}/status`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
  ...
  const handleCompleteTask = async (task) => {
    ...
    try {
      const res = await fetch(`https://cws-tms-backend.vercel.app/task/${task._id}/status`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
