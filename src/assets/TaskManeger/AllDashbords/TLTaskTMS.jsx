...
const TLTaskTMS = ({ role }) => {
  ...
  const fetchTaskComments = async (taskId) => {
    ...
    try {
      const response = await axios.get(
        `https://cws-tms-backend.vercel.app/task/${taskId}/comments`,
      );
  ...
  const handleSubmitComment = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://cws-tms-backend.vercel.app/task/${commentModalTask._id}/comment`,
        { comment: newComment },
        {
          headers: {
  ...
  const handleDeleteComment = async (commentId, taskId) => {
    ...
    try {
      ...
      const res = await axios.delete(
        `https://cws-tms-backend.vercel.app/task/${taskId}/comment/${commentId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  async function fetchUser() {
    try {
      const token = localStorage.getItem("accessToken");
      const response = await axios.get("https://cws-tms-backend.vercel.app/me", {
  ...
  const fetchTeamLeaderProjects = async (teamLeadId) => {
    try {
      const response = await axios.get(`https://cws-tms-backend.vercel.app/${teamLeadId}/projects`);
  ...
  const fetchTasks = async () => {
    try {
      ...
      const res = await axios.get(`https://cws-tms-backend.vercel.app/tasks/${teamLeadId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchStatuses = async () => {
    try {
      const res = await axios.get(`https://cws-tms-backend.vercel.app/unique`);
      if (res.data.success) {
  ...
  const fetchEmployeesForProject = async (projectName) => {
    ...
    try {
      ...
      const projectsRes = await axios.get("https://cws-tms-backend.vercel.app/api/projects", {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      if (selectedProject && selectedProject._id) {
        const empRes = await axios.get(
          `https://cws-tms-backend.vercel.app/projects/employees/${selectedProject._id}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
  ...
  useEffect(() => {
    const fetchAddTaskRequiredDetails = async () => {
      try {
        ...
        const res = await axios.get("https://cws-tms-backend.vercel.app/getAllDepartments");
        const empRes = await axios.get(
          `https://cws-tms-backend.vercel.app/employees/manager/${teamLeadId}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
        const taskTypeRes = await axios.get(
          `https://cws-tms-backend.vercel.app/api/task-types/unique-names`,
        );
  ...
  async function handleAddTask(e) {
    ...
    try {
      ...
      const leaveRes = await axios.get(
        `https://cws-tms-backend.vercel.app/leave/manager/${user._id}`,
      );
      ...
      const holidaysRes = await axios.get("https://cws-tms-backend.vercel.app/getHolidays");
      ...
      if (editTaskId) {
        await axios.put(
          `https://cws-tms-backend.vercel.app/task/${editTaskId}`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
        ...
        await axios.post(
          "https://cws-tms-backend.vercel.app/task/create",
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
...
if (searchInput.trim() !== "") {
  ...
  const handleDeleteTask = async (id) => {
    ...
    try {
      await axios.delete(`https://cws-tms-backend.vercel.app/task/${id}`);
...
const chartOptions = {
  ...
  const handleEditSave = async (task) => {
    try {
      ...
      await axios.put(`https://cws-tms-backend.vercel.app/task/${task._id}`, formData, {
        headers: {
