...
function AdminTypeOfTask() {
  ...
  const fetchTaskTypes = async () => {
    try {
      const res = await axios.get("https://cws-tms-backend.vercel.app/api/task-types");
      // setItems(res.data || []);
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      await axios.post("https://cws-tms-backend.vercel.app/api/task-types", {
        name: newName.trim(),
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://cws-tms-backend.vercel.app/api/task-types/${editId}`, {
        name: newName.trim(),
        description: newDesc?.trim() || "",
        priority: newPriority,
        isActive: newIsActive,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://cws-tms-backend.vercel.app/api/task-types/${id}`);
