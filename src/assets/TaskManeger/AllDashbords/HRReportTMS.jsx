...
function HRReportTMS() {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      const res = await axios.get("https://cws-tms-backend.vercel.app/task/getall");
...
if (statusName === "Delayed") {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const res = await axios.get("https://cws-tms-backend.vercel.app/api/projects");
    ...
    const fetchData = async () => {
      try {
        ...
        const [employeesRes, tasksRes, projectsRes] = await Promise.all([
          axios.get("https://cws-tms-backend.vercel.app/getAllEmployees", { headers }),
          axios.get("https://cws-tms-backend.vercel.app/task/getall", { headers }),
          axios.get("https://cws-tms-backend.vercel.app/api/projects", { headers }),
        ]);
