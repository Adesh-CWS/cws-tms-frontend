...
//   useEffect(() => {
//     axios
//       .get("https://cws-tms-backend.vercel.app/admin/office-location")
//       .then((res) => {
...
//   setLoading(true);
//   try {
//     await axios.post("https://cws-tms-backend.vercel.app/admin/office-location", location);
...
const handleSave = () => {
  ...
  axios
    .post("https://cws-tms-backend.vercel.app/admin/office-location", editLocation)
    .then(() => {
