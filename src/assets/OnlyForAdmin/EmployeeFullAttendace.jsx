  ...
  useEffect(() => {
    const fetchHolidays = async () => {
      try {
        ...
        const response = await axios.get("https://cws-tms-backend.vercel.app/getHolidays", {
  ...
  useEffect(() => {
    const fetchWeeklyOffConfig = async () => {
      try {
        ...
        const response = await axios.get(`https://cws-tms-backend.vercel.app/admin/weeklyoff/${currentYear}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
    ...
    const fetchData = async () => {
      try {
        ...
        const empRes = await axios.get(
          `https://cws-tms-backend.vercel.app/employees/${empId}`,
        );
  ...
  const handleRowClick = async (att) => {
    ...
    try {
      ...
      const res = await axios.get(
        `https://cws-tms-backend.vercel.app/api/break/admin/${empId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
