      ...
      const fetchEmployee = async () => {
        try {
          ...
          const res = await axios.get(
            `https://cws-tms-backend.vercel.app/getEmployee/${empId}`,
            {
...
if (name.startsWith("bankDetails.")) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://cws-tms-backend.vercel.app/employees/${employee._id || empId}`,
        data,
        {
          headers: {
      ...
      const updated = await axios.get(
        `https://cws-tms-backend.vercel.app/getEmployee/${employee._id || empId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const getDocumentPreview = (fileName, label) => {
    ...
    const url = fileName.startsWith("http")
      ? fileName
      : `https://cws-tms-backend.vercel.app/uploads/${fileName}`;
  ...
  const handlePermanentDelete = async (id) => {
    ...
    try {
      ...
      const res = await axios.delete(
        `https://cws-tms-backend.vercel.app/deleteEmployee/${id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
                ...
                <img
                  src={
                    employee?.image?.startsWith("http")
                      ? employee.image
                      : `https://cws-tms-backend.vercel.app/uploads/${employee.image}`
                  }
                  alt="Profile Preview"
                  style={{
                    width: "100px",
            ...
            <div className="d-flex gap-3 flex-wrap">
                    ...
                    <a
                      href={
                        employee[field]?.startsWith("http")
                          ? employee[field]
                          : `https://cws-tms-backend.vercel.app/uploads/${employee[field]}`
                      }
                      target="_blank"
              ...
              <div className="d-flex flex-column align-items-start">
                ...
                {isEditing ? (
                  ...
                  <a
                    href={`https://cws-tms-backend.vercel.app/uploads/${employee.bankDetails.passbookPdf}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
