...
function EmployeeApplyLeave({ user, onLeaveApplied }) {
    ...
    const fetchTeamLeaders = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://cws-tms-backend.vercel.app/employee/${user._id}/team-leader`,
          {
            headers: { 'Authorization': `Bearer ${token}` }
          }
        );
  ...
  useEffect(() => {
    const fetchManager = async () => {
      ...
      try {
        ...
        const res = await axios.get(`https://cws-tms-backend.vercel.app/users/${user.reportingManager}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // const existingLeavesRes = await axios.get(`https://cws-tms-backend.vercel.app/leave/my/${user._id}`);
  ...
  const getApplyToValue = () => {
    ...
    const confirmApplyLeave = async () => {
      ...
      try {
        ...
        await axios.post(
          "https://cws-tms-backend.vercel.app/leave/apply",
          {
            employeeId: user._id,
            leaveType: form.leaveType,
            dateFrom: dateFromParsed,
