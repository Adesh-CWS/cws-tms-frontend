...
const ActivePolls = ({ user }) => {
  ...
  useEffect(() => {
    ...
    const fetchActivePoll = async () => {
      try {
        const res = await axios.get("https://cws-tms-backend.vercel.app/api/polls/active");
  ...
  useEffect(() => {
    const fetchPreviousPolls = async () => {
      try {
        const res = await axios.get("https://cws-tms-backend.vercel.app/api/polls/previous");
  ...
  const createPoll = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://cws-tms-backend.vercel.app/api/polls/create",
        {
      ...
      const activeRes = await axios.get(
        "https://cws-tms-backend.vercel.app/api/polls/active"
      );
  ...
  const editPoll = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://cws-tms-backend.vercel.app/api/polls/${editingPoll._id}`,
        {
  ...
  const deletePoll = async (pollId) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      await axios.delete(
        `https://cws-tms-backend.vercel.app/api/polls/${pollId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchVotedMembers = async (pollId, pollQuestion, pollOptions, pollType) => {
    try {
      ...
      const res = await axios.get(
        `https://cws-tms-backend.vercel.app/api/polls/${pollId}/voted-members`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const votePoll = async (pollId, optionIndex) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://cws-tms-backend.vercel.app/api/polls/vote",
