  ...
  const fetchData = async () => {
    try {
      ...
      const res = await axios.get(
        "https://cws-tms-backend.vercel.app/attendance/regularization/all",
        {
 ...
 const handleStatusChange = async (id, status) => {
  ...
  try {
    ...
    const res = await axios.put(
      `https://cws-tms-backend.vercel.app/attendance/regularization/${id}/status`,
      {
        status,
      ...
      item._id === id
        ? {
            ...
            regularizationRequest: {
              ...
              actionReason,
              approvedByName:
              res.data.record.regularizationRequest.approvedByName,
            approvedByRole:
              res.data.record.regularizationRequest.approvedByRole,
            },
          }
        : item
    );
