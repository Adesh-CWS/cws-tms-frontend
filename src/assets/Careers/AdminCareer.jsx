...
function AdminCareer({ user }) {
  ...
  const fetchJobs = async () => {
    try {
      const res = await fetch("https://cws-tms-backend.vercel.app/api/jobs/");
  ...
  typeof newJob.importantSkills === "string"
    ...
    : newJob.importantSkills,
      ...
      if (editJobId) {
        res = await axios.put(
          `https://cws-tms-backend.vercel.app/api/jobs/${editJobId}`,
          payload,
        ...
        const res = await axios.post(
          "https://cws-tms-backend.vercel.app/api/jobs/",
          payload,
          { headers: { "Content-Type": "application/json" } },
        );
        await fetchJobs();
  ...
  async function handleDelete(id, e) {
    ...
    try {
      await axios.delete(`https://cws-tms-backend.vercel.app/api/jobs/${id}`);
...
temp.sort((a, b) => {
  ...
  const getApplicantsInfo = async (jobId) => {
    try {
      ...
      const res = await fetch(`https://cws-tms-backend.vercel.app/api/apply/job/${jobId}`, {
        method: "GET",
        headers: {
...
const resetFilters = () => {
  ...
  async function handleStatusChange(applicationId, newStatus) {
    try {
      await axios.put(`https://cws-tms-backend.vercel.app/api/apply/${applicationId}`, {
        status: newStatus,
      });
