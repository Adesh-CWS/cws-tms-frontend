...
const [phone, setPhone] = useState("");
  ...
  const fetchAppliedJobs = async () => {
    try {
      const res = await fetch(
        `https://cws-tms-backend.vercel.app/api/apply/employee/${user._id}?applicantType=inhouse`,
      );
  ...
  const fetchRefferedJobs = async () => {
    try {
      const res = await fetch(
        `https://cws-tms-backend.vercel.app/api/apply/employee/${user._id}?applicantType=referral`,
      );
  ...
  const createApplication = (formData) =>
    axios.post("https://cws-tms-backend.vercel.app/api/apply", formData, {
