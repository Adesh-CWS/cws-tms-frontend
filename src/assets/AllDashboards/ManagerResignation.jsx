...
useEffect(() => {
  ...
  const fetchResignations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-tms-backend.vercel.app/resignation/manager/${managerId}`,
        {
          headers: {
  ...
  const handleDeleteResignation = async (resignationId) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://cws-tms-backend.vercel.app/cancel/resignation/${resignationId}`,
        {
  ...
  const handleResignationAction = async (action) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://cws-tms-backend.vercel.app/resignation/${selected.originalData.resignationId}`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleApplyResignation = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://cws-tms-backend.vercel.app/resignation/apply",
        {
  ...
  const fetchMyResignations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-tms-backend.vercel.app/resignation/${empId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-body">
                <div className="container-fluid">
                  ...
                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold">{selectedMyResignation.status?.toLowerCase() === "approved"
    ? "Approve By"
    : selectedMyResignation.status?.toLowerCase() === "rejected"
    ? "Reject By"
    : "Reviewe By"}</div>
                    <div className="col-7 col-sm-8">
  ...
  >
    {selectedMyResignation.approvedDate
      ...
      : "N/A"}
                  ...
                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold">
                       {selectedMyResignation.status?.toLowerCase() === "approved"
  ? "Approver Comment"
  : selectedMyResignation.status?.toLowerCase() === "rejected"
  ? "Rejector Comment"
  : "Reviewer Comment"}
