...
const EmployeeFeedback = () => {
  ...
  const fetchRecipients = async () => {
    try {
      ...
      let recipients = [];
      // 1. Fetch HR users
      const hrResponse = await axios.get("https://cws-tms-backend.vercel.app/gethr", {
        headers: {
      ...
      try {
        const userResponse = await axios.get(
          `https://cws-tms-backend.vercel.app/users/${currentUser._id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
...
if (
      ...
      designation: manager.designation || "",
        ...
        if (userData.role && userData.role.toLowerCase() === "manager") {
          const employeesResponse = await axios.get(
            `https://cws-tms-backend.vercel.app/managers/${currentUser._id}/assigned-employees`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
          ...
          if (employeesResponse.data.success) {
            ...
            employees.forEach((emp) => {
              ...
              const tlResponse = await axios.get(
                "https://cws-tms-backend.vercel.app/teamLead",
                {
        ...
        if (userData.role && userData.role.toLowerCase() === "team_leader") {
          const teamMembersResponse = await axios.get(
            `https://cws-tms-backend.vercel.app/${currentUser._id}/members`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const fetchFeedbacks = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-tms-backend.vercel.app/feedback/employee/${currentUser._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const markAsViewed = async (feedbackId) => {
    try {
      ...
      const response = await axios.put(
        `https://cws-tms-backend.vercel.app/feedback/view/${feedbackId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    try {
      ...
      if (editId) {
        response = await axios.put(
          `https://cws-tms-backend.vercel.app/feedback/edit/${editId}`,
          {
        ...
        response = await axios.post(
          "https://cws-tms-backend.vercel.app/feedback/send",
          {
  ...
  const handleDelete = async (id, e) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      if (token) {
        await axios.delete(`https://cws-tms-backend.vercel.app/feedback/delete/${id}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
