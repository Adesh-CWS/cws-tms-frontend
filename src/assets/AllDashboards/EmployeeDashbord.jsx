    ...
    const fetchData = async () => {
      try {
        const [leaveRes, regRes] = await Promise.all([
          axios.get(`https://cws-tms-backend.vercel.app/leave/my/${user._id}`),
          axios.get(
...
const handleStartBreak = async () => {
                  ...
                  <div className="ms-0">
                    ...
                    <div className="d-flex align-items-center gap-2 mb-2">
                      ...
                      >
                       ...
                       <span style={{ width: "15px" ,   color: "#3A5FBE", fontSize: "18px",
                          fontWeight: "500",}}>:</span>
                  {workMode === "WFH" ? (
                      <input
                        type="text"
                        ...
                        value="Lunch"
                        readOnly
                        style={{ maxWidth: "200px",  minWidth: "90px", }}
                      />
                    ) : (
                      <select
                    ...
                    <div className="d-flex align-items-center mb-2">
                      ...
                      >
                       ...
                       <span style={{ width: "24px",   color: "#3A5FBE",   fontSize: "18px",
                          fontWeight: "500",}}>:</span>
                      <span
                        style={{
                           minWidth: "110px",
  ...
  style={{ color: "#3A5FBE", fontSize: "25px", cursor: "pointer" }}
