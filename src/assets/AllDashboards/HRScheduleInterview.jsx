...
const BASE_URL = "https://cws-tms-backend.vercel.app";
...
const [downloadUrl, setDownloadUrl] = useState("");
  ...
  useEffect(() => {
    axios
      .get("https://cws-tms-backend.vercel.app/allEmp")
      .then((res) => {
  ...
  const fetchAllInterviews = () => {
    axios
      .get("https://cws-tms-backend.vercel.app/interviews")
      .then((res) => {
        if (res.data.success) {
  ...
  const handleDeleteInterview = async (id) => {
    ...
    try {
      const res = await axios.delete(
        `https://cws-tms-backend.vercel.app/interviewsDelete/${id}`,
      );
  ...
  const handleUpdateInterview = async (id, formData) => {
    ...
    try {
      const res = await axios.put(
        `https://cws-tms-backend.vercel.app/interviewsUpdate/${id}`,
        formData, {
        headers: {
...
if (
  ...
  newErrors.link = "Interview link is required";
    ...
    const token = localStorage.getItem("accessToken");
    axios
      .post("https://cws-tms-backend.vercel.app/schedule-interview", formPayload, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`
        },
